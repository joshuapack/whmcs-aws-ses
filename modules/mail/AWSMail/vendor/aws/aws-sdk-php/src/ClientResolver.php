...
class ClientResolver
{
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            ...
            $args['region'] = self::strip_fips_pseudo_regions($args['region']);
...
EOT;
    ...
    {
        return self::is_valid_hostlabel($region);
    }
     ...
     * @return string
     */
    private static function strip_fips_pseudo_regions($region)
    {
     ...
     * @return bool
     */
    private static function is_valid_hostlabel($label)
    {
